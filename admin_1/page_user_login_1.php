...
//}
    if(!isset($_SESSION["username"]) && !isset($_SESSION["email"])) {
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <!--        <form class="login-form loginCheck" action="../controllers/loginControllers.php" method="post">-->
            <h3 class="form-title font-green">Sign In</h3>
            <div class="alert alert-danger display-hide">
                <button class="close" data-close="alert"></button>
                <span class="errorLogin"> Enter any email and password. </span>
            </div>
            <div class="form-group">
                <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
                <label class="control-label visible-ie8 visible-ie9">Email</label>
                <input class="form-control form-control-solid placeholder-no-fix emailValueLogin" type="email"
                       placeholder="Email" name="email" autofocus/>
            </div>

            <div class="form-group">
                <label class="control-label visible-ie8 visible-ie9">Password</label>
                <input class="form-control form-control-solid placeholder-no-fix passwordValueLogin" type="password"
                       autocomplete="off" placeholder="Password" name="password"/>
            </div>
            <div class="form-actions">
                <input type="submit" name="login" class="btn green uppercase loginCheck" value="Login">
